<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edicion.aspx.cs" Inherits="SW_CIDEAUTOS.Edicion" %>
...
<body>
    ...
    &nbsp;
            ...
            <p>
                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Modificar" Width="188px" />
            </p>
            <p>
