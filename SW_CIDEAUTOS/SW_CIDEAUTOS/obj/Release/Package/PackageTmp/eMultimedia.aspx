<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="eMultimedia.aspx.cs" Inherits="SW_CIDEAUTOS.eMultimedia" %>
...
<body>
    ...
    <h1>Editar Link de listado de videos</h1>
    <br />
    <table>
        <tr>
            <td><asp:Label ID="Label1" runat="server" Text="Link: "></asp:Label></td>
            <td><asp:TextBox ID="txtLink" runat="server" Width="630px"></asp:TextBox></td>
            <td><asp:Button ID="Button3" runat="server" Text="Modificar" OnClick="Button3_Click" /></td>
        </tr>
    </table>
    <p>&nbsp;</p>
    <h1>Editar Imagenes del Slider</h1>
    <h2>Seleccione imagen... Requiere 600*350 pixeles</h2>
        <p>&nbsp;</p>
        <p class="txt-center">
...
&nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Agregar imagen" />
        ...
        <p>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText=" ">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" ID="btnEliminar" Text="Eliminar" CommandName="Eliminar"
                            CommandArgument='<%# Eval("cod_imagen") %>' Style="font-size: 24px;"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
        ...
        <p>&nbsp;</p>
        <p class="txt-center">
            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Actualizar imagenes" Width="368px" />
        </p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
    </form>
