<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="eImagenes.aspx.cs" Inherits="SW_CIDEAUTOS.eImagenes" %>
...
<body>
    ...
    <h1>Editar Imagenes del Carro</h1>
...
&nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Agregar imagen" />
        ...
        <p>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText=" ">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" ID="btnReemplazar" Text="Reemplazar" CommandName="Reemplazar"
