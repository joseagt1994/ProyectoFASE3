<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Imagenes.aspx.cs" Inherits="SW_CIDEAUTOS.Imagenes" %>
...
&nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Agregar imagen" />
        ...
        <p>&nbsp;</p>
        <p>
            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Guardar imagenes" Width="368px" />
        </p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
    </form>
